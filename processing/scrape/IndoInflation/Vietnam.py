...
from processing.constant import driver_path, your_user, your_db_table, your_host, your_password, your_database
from processing.database import Database
from processing.scrape.IndoInflation.extract_xml import extract_xml
from processing.scrape.IndoInflation import calculate
...
class Scraper(webdriver.Chrome):
   ...
   Methods:
       ...
       database_connection(self, option=None, indicator=None, create_table=True, table_show=False, delete_table=False,
       insert_data=False):
   ...
   """
    ...
    def __init__(self, driver=driver_path, teardown=False):
       ...
       """
        ...
        super(Scraper, self).__init__(service=service, options=chrome_options)
    ...
    def database_connection(self, option=None, indicator=None, create_table=True,
       ...
       """
        ...
        if create_table:
            ...
            db.insert_data(df=df)

# Example usage:
def main(option=None, indicator=None, create_table=True, table_show=False, delete_table=False, insert_data=False):
    ...
    scraper.database_connection(option, indicator, create_table, table_show, delete_table, insert_data)
    return df
