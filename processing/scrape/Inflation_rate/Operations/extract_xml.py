...
def extract_xml(url, country_ = None, link_ = None, source_ = None, update_fq_ = None):
    """
    ...
    if country_ is None:
        country_ = "Vietnam"
    if link_ is None:
        link_ = 'https://nsdp.gso.gov.vn/index.htm'
    if source_ is None:
        source_ = 'GENERAL STATISTICS OFFICE'
    if update_fq_ is None:
        update_fq_ = 'Monthly'
